...
class MainWindow(QWidget):
	def __init__(self, parent = None):
		...
		# Open File Button (TBD, perlu gak?)
		self.fopenbut = QPushButton('Open File...')
		grid.addWidget(self.fopenbut, 1, 0)
		self.fopenbut.clicked.connect(self.choose_file)
	...
	def setTableContentGA(self):
		...
		for i in range (len(varMatkul[0])):
			...
			if (varMatkul[0][i].hari == 1):
				for j in range (0, lama):
					...
					if (self.table.cellWidget(start, 0) == None):
				...
				for j in range (0,lama):
					soda = varMatkul[0][i].kode + '  -  ' + varMatkul[0][i].kelas
					item = QTableWidgetItem(soda)
					if (self.table.cellWidget(start, 1) == None):
						self.minitable = SubTableWidget()
				...
				for j in range (0,lama):
					soda = varMatkul[0][i].kode + '  -  ' + varMatkul[0][i].kelas
					item = QTableWidgetItem(soda)
					if (self.table.cellWidget(start, 2) == None):
						self.minitable = SubTableWidget()
				...
				for j in range (0,lama):
					soda = varMatkul[0][i].kode + '  -  ' + varMatkul[0][i].kelas
					item = QTableWidgetItem(soda)
					if (self.table.cellWidget(start, 3) == None):
						self.minitable = SubTableWidget()
				...
				for j in range (0,lama):
					soda = varMatkul[0][i].kode + '  -  ' + varMatkul[0][i].kelas
					item = QTableWidgetItem(soda)
					if (self.table.cellWidget(start, 4) == None):
						self.minitable = SubTableWidget()
		...
		for c in range (0, len(listconstraint)):
			...
			for d in range (0, A.rowCount()):
				B = A.item(d,0)
				B.setBackgroundColor(QColor(150,0,0))
			z = z + 1
